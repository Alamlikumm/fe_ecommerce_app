...
import { Minus, Plus, Trash2, ShoppingBag, ArrowLeft, Truck, Tag, Package } from "lucide-react";
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 sticky top-24 space-y-6">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button className="px-4 py-2.5 bg-gray-900 dark:bg-gray-700 text-white rounded-xl text-sm font-bold hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors">
                                        Pakai
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="border-t border-gray-100 dark:border-gray-800 pt-4 space-y-3">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-bold text-gray-700 dark:text-gray-300">{totalItems} pcs</span>
                                </div>
                                <div className="flex justify-between text-sm">
                                    <span className="text-gray-500">Ongkos Kirim</span>
                                    <span className="font-bold text-emerald-600">
                                        {remaining <= 0 ? "GRATIS" : "Rp 15.000"}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="border-t border-gray-100 dark:border-gray-800 pt-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-2xl font-black gradient-text-warm">
                                        Rp {new Intl.NumberFormat("id-ID").format(totalPrice + (remaining > 0 ? 15000 : 0))}
                                    </span>
                                </div>
                            </div>
